...
|-------------|-------------|---------------|-------|
| Diagrams | 137 | 137 | H4 headers starting with '#### Diagram:' |
| Equations | 401 | 401 | LaTeX expressions (inline and display) |
| Total Words | 153,174 | 109,525 | Words in markdown files |
| Links | 464 | 163 | Hyperlinks in markdown format |
| Equivalent Pages | 650 | 475 | Estimated pages (250 words/page + visuals) |
