...
| 3 | MicroSims | 104 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 11 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 13 / 13 | Recommended | Chapters with a quiz.md (123 questions total) |
| 6 | Chapter References | 0 / 13 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 389 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 158 | Recommended | Questions in faq.md |
| 9 | Words | 257,809 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 117 | 117 | H4 headers starting with '#### Diagram:' |
| Equations | 1037 | 933 | LaTeX expressions (inline and display) |
| Total Words | 257,809 | 112,471 | Words in markdown files |
| Links | 1090 | 227 | Hyperlinks in markdown format |
| Equivalent Pages | 1112 | 531 | Estimated pages (250 words/page + visuals) |
