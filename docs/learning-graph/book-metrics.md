...
| Quiz Questions | 123 | - | Questions across all chapters |
| MicroSims | 98 | [Simulations](../sims/index.md) | Interactive MicroSims |
...
|-------------|-------------|---------------|-------|
| Diagrams | 118 | 118 | H4 headers starting with '#### Diagram:' |
| Equations | 765 | 665 | LaTeX expressions (inline and display) |
| Total Words | 186,113 | 111,590 | Words in markdown files |
| Links | 659 | 206 | Hyperlinks in markdown format |
| Equivalent Pages | 822 | 524 | Estimated pages (250 words/page + visuals) |
