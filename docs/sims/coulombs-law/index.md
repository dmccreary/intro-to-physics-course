...
<iframe src="main.html" height="602px" width="100%" scrolling="no" style="border: none; overflow: hidden;"></iframe>
...
- Apply Coulomb's Law to calculate electric forces
- Predict whether charges will attract or repel
- Understand the inverse square relationship between force and distance
