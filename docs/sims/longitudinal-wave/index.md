...
[Run the Longitudinal Wave Animation Fullscreen](./main.html){ .md-button .md-button--primary }
...
Use this simulation alongside the Transverse Wave Animation to compare:
- Direction of particle motion relative to wave direction
- How energy is transferred in each type
