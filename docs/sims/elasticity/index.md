...
og:image: /sims/elasticity/elasticity.png
twitter:image: /sims/elasticity/elasticity.png
social:
   cards: false
---
...
[Run the Elasticity MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
