...
- **Maximum PE, minimum KE**: At the highest points (cart moves slowest)
- **Maximum KE, minimum PE**: At the lowest points (cart moves fastest)
- **Total energy**: Remains constant (green line stays flat)
