...
When arms are pulled in:
- **I decreases** (mass moves closer to rotation axis)
- **ω must increase** to keep L constant
- The skater spins faster!

When arms extend:
- **I increases** (mass moves farther from axis)
- **ω must decrease** to keep L constant
- The skater slows down!
