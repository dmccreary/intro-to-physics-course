...
This interactive diagram demonstrates how torque depends on three factors:
- **Force magnitude (F)** - Larger forces create more torque
- **Distance from pivot (r)** - Forces applied farther from the pivot create more torque
- **Angle (θ)** - Forces perpendicular to the lever arm create maximum torque
