...
[Run the Sine Wave MicroSim](./main.html){ .md-button .md-button--primary }
...
1. [Sine Wave - Wikipedia](https://en.wikipedia.org/wiki/Sine_wave) - Mathematical definition and properties of sine waves

2. [Amplitude, Period, Phase Shift](https://www.mathsisfun.com/algebra/amplitude-period-frequency-phase-shift.html) - Math is Fun - Interactive explanation of trigonometric wave parameters

3. [Trigonometry and Sound](https://www.acs.psu.edu/drussell/Demos/waves/wavemotion.html) - Penn State Acoustics - Wave motion animations and explanations
