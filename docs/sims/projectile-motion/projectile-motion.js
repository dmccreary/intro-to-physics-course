...
let power = 12;                      // Launch power/velocity
...
function setup() {
  ...
  // Power slider (5-25)
  powerSlider = createSlider(2, 20, power, 0.5);
  ...
  fireButton.position(canvasWidth - 150, drawHeight + 10);
  fireButton.mousePressed(fireCannon);
  fireButton.style('padding', '2px 8px');
  fireButton.style('font-size', '14px');

  // Reset button
  resetButton = createButton('Reset');
  resetButton.position(canvasWidth - 150, drawHeight + 40);
