...
[Run the Inertia Demonstration Fullscreen](./main.html){ .md-button .md-button--primary }
...
1. Adjust the **Force** slider to set the applied force (5-50 N)
2. Adjust the **Time** slider to set how long the force is applied
3. Click **Apply Force** to push all three objects with equal force
4. Observe how different masses result in different accelerations
5. Watch the objects continue at constant velocity after the force stops
