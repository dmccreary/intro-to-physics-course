---
title: Physics MicroSims
description: A collection of interactive educational MicroSims for high school physics covering mechanics, dynamics, energy, waves, and electricity
hide:
    - toc
---
# Physics MicroSims
...
- **[Atwood Machine Free-Body Diagram](./atwood-fbd/index.md)**
    ...
    ![Atwood FBD](./atwood-fbd/atwood-fbd.png)
    Interactive visualization of free-body diagrams for the Atwood machine showing how to set up and solve the equations.

- **[Atwood Machine](./atwood-machine/index.md)**

    ![Atwood Machine](./atwood-machine/atwood-machine.png)
...
- **[Charging by Induction](./charging-induction/index.md)**
    ...
    ![Charging by Induction](./charging-induction/charging-induction.png)
...
- **[Collision Types Comparison](./collision-types/index.md)**

    ![Collision Types](./collision-types/collision-types.png)
...
- **[Types of Damping Comparison](./damping-types/index.md)**
    ...
    ![Damping Types](./damping-types/damping-types.png)
...
- **[Electric Field Lines Visualization](./electric-field-lines/index.md)**
    ...
    ![Electric Field Lines](./electric-field-lines/electric-field-lines.png)
...
- **[Exoplanet Transit Detection](./exoplanet/index.md)**
    ...
    ![Exoplanet](./exoplanet/exoplanet.png)
...
- **[Fluid Dynamics](./fluid-dynamics/index.md)**
    ...
    ![Fluid Dynamics](./fluid-dynamics/fluid-dynamics.png)
...
- **[Interactive Graph Analysis](./graph-analysis/index.md)**
    ...
    ![Graph Analysis](./graph-analysis/graph-analysis.png)
...
- **[Hooke's Law Interactive](./hookes-law-demo/index.md)**
    ...
    ![Hooke's Law](./hookes-law-demo/hookes-law-demo.png)
...
- **[Precision vs Accuracy](./precision-accuracy/index.md)**
    ...
    ![Precision vs Accuracy](./precision-accuracy/precision-accuracy.png)
...
- **[River Crossing Relative Velocity](./river-crossing/index.md)**
    ...
    ![River Crossing](./river-crossing/river-crossing.png)
...
- **[Solar System](./solar-system/index.md)**
    ...
    ![Solar System](./solar-system/solar-system.png)
...
- **[Variable Force Work Calculation](./variable-force-work/index.md)**
    ...
    ![Variable Force Work](./variable-force-work/variable-force-work.png)
